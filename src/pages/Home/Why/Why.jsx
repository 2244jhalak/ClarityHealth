    ...
    return (
        <div className='my-10'>
            ...
            <div className="text-center py-5">
                ...
                <img className='text-center lg:w-56 w-36' src={High} alt="" />
                </div>
                <h2 className="text-2xl font-semibold">High Engagement Promotions</h2>
            </div>
            <div className="text-center py-5">
                <div className='flex items-center justify-center'>
                <img className='text-center lg:w-56 w-36' src={Member} alt="" />
                </div>
                <h2 className="text-2xl font-semibold">Membership Plans</h2>
            </div>
            <div className="text-center py-5">
                <div className='flex items-center justify-center'>
                <img className='text-center lg:w-56 w-36' src={Discount} alt="" />
                </div>
